...
$clear = array_util::Value($_GET, "clear","false");

if ($clear == "true") unset($_SESSION['map_path']);
...
<INPUT TYPE=HIDDEN ID="ZoomFactor" NAME="ZoomFactor" VALUE=""><INPUT TYPE=HIDDEN ID="UserLayer"  NAME="UserLayer"   VALUE="" ><INPUT TYPE=HIDDEN ID="SpeciesID"  NAME="SpeciesID"   VALUE="<?php echo $SpeciesID; ?>" ><INPUT TYPE=HIDDEN ID="extent"     NAME="extent"  VALUE="<?php echo $GUI->ExtentString(); ?>"></FORM>
</body>
</html>